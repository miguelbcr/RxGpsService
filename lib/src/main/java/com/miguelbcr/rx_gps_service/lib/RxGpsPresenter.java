        ...
        subscriptions.add(new RxLocation(gpsConfig).getCurrentLocationForService()
                .flatMap(new Func1<Location, Observable<Float>>() {
                    ...
                    public Observable<Float> call(Location location) {
                        ...
                        return utilities.getDistanceFromTo(getLatLong(lastLocation, false), getLatLong(location, false));
                    }
                })
                .concatMap(new Func1<Float, Observable<Float>>() {
                    @Override
                    public Observable<Float> call(Float distance) {
                        ...
                        getTripSpeed.setParams(distance.longValue(), timeLastLocation, gpsConfig.getDiscardSpeedsAbove());
                ...
                .concatMap(new Func1<Float, Observable<Boolean>>() {
                    @Override
                    public Observable<Boolean> call(Float speed) {
                ...
                .subscribe(new Action1<Boolean>() {
                    @Override
                    public void call(Boolean isMeaning) {
                        if (isMeaning) {
    ...
    private Observable<RouteStats> getMeaningObservableRouteStats(Observable<Long> oRecordTime) {
        ...
        return oRecordTime
                .concatMap(new Func1<Long, Observable<Long>>() {
                    @Override
                    public Observable<Long> call(Long timeElapsedChrono) {
                ...
                .concatMap(new Func1<Long, Observable<Long>>() {
                    @Override
                    public Observable<Long> call(Long timeElapsed) {
                        if (!isMeaningWaypoint) return Observable.just(distanceAccumulated);
                        if (isWaypointsEmpty() || hasOnlyOneWaypoint())
                ...
                .concatMap(new Func1<Long, Observable<Float>>() {
                    @Override
                    public Observable<Float> call(Long distance) {
                        ...
                        getTripSpeed.setParams(getTripDistance.getLastDistance(), lastTimeElapsed, gpsConfig.getDiscardSpeedsAbove());
                ...
                .concatMap(new Func1<Float, Observable<Float>>() {
                    @Override
                    public Observable<Float> call(Float speed) {
                ...
                .concatMap(new Func1<Float, Observable<Float>>() {
                    @Override
                    public Observable<Float> call(Float speedAverage) {
                ...
                .concatMap(new Func1<Float, Observable<Float>>() {
                    @Override
                    public Observable<Float> call(Float speedMax) {
                ...
                .map(new Func1<Float, RouteStats>() {
                    @Override
                    public RouteStats call(Float speedMin) {
